...
const SubscribePremiuiBtn = () => {
  return (
    <div className='h-20 w-56 translate-y-20 relative group rounded-3xl px-8 border-2 border-[#E9C46A] border-l-0 duration-300 overflow-hidden flex justify-between items-center cursor-pointer active:translate-y-1 '>
        <ArrowLeftIcon/>
